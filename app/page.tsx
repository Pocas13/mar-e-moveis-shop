...
const divisoes = [
  { nome: "Sala", slug: "sala", imagem: "/ambientes/sala.svg", frase: "Conforto para todos os dias" },
  { nome: "Quarto", slug: "quarto", imagem: "/ambientes/quarto.svg", frase: "Descanso com personalidade" },
  { nome: "Sala de jantar", slug: "sala-de-jantar", imagem: "/ambientes/jantar.svg", frase: "Espaço para reunir" },
  { nome: "Escritório", slug: "escritorio", imagem: "/ambientes/escritorio.svg", frase: "Trabalhar com mais conforto" },
];
  ...
  return <>
    <section className="container-site pt-5 sm:pt-8"><div className="hero-modern">
      ...
      <div className="relative z-10 flex min-h-[640px] max-w-2xl flex-col justify-center px-7 py-16 sm:px-14 lg:px-20">
        ...
        <div className="mt-9 flex flex-wrap gap-3"><a href="#novidades" className="rounded-full bg-barro-500 px-7 py-4 text-sm font-bold text-white hover:bg-barro-400">Ver novidades</a><a href="#divisoes" className="rounded-full border border-white/40 bg-white/5 px-7 py-4 text-sm font-bold text-white backdrop-blur hover:bg-white hover:text-grafite-900">Comprar por divisão</a></div>
      </div>
    </div></section>
